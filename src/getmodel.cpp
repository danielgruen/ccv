...
int main(int argc, char **argv)
{
	...
	CovarianceModel model(zlens, zsource, log10mass100, log10mass100+1, ccorr, cconc, cell); 
		// it's ok to just say CovarianceModel model(zlens, zsource) if you want the default
