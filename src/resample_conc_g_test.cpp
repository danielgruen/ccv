// compress an covariance matrix (conc) to the system of annuli used
...
int main(int argc, char **argv)
{
  ...
  
  {
    ...
    ss << nc;
    cout << "opening templates/conc_g/cov_"+ss.str()+".fits" << endl;
    auto_ptr<FITS> pInfile(new FITS("templates/conc_g/cov_"+ss.str()+".fits",Read,true));
